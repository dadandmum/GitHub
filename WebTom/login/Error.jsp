...
<head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="3;url=../login/index.jsp">
    ...
    <!-- *********  Header  ********** -->
     ...
     <div class="content" >
				<div class="button-wrapper">
					<a href="../login/index.jsp" class="a-btn">
						<span class="a-btn-text">Back</span> 
						<span class="a-btn-slide-text">log in again!</span>
